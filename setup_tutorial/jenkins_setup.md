...
Each student gets two jobs in Jenkins: oop2025f\_\${STUDENT\_ID}\_HW and oop2025f\_\${STUDENT\_ID}\_HW\_TA. Once you push changes to your GitLab repository, oop2025f\_\${STUDENT\_ID}\_HW is triggered to compile your code and run the tests you wrote. If oop2025f\_\${STUDENT\_ID}\_HW built successfully, oop2025f\_\${STUDENT\_ID}\_HW\_TA will start to run the test from TA to test your code.
...
To get full score, you need to make the job oop2025f\_\${STUDENT\_ID}\_HW\_TA passed. Before due date, there is no limit times for updating your code. Please start early and try hard fixed code for passing the tests from TA.
